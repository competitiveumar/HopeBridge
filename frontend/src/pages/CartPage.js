...
import { validateGiftCard, markGiftCardAsUsed } from '../utils/giftCardCodes';
...
const GiftCardForm = () => {
  ...
  const handleApplyGiftCard = async () => {
    ...
    try {
      const result = validateGiftCard(code.toUpperCase());
      ...
      markGiftCardAsUsed(code.toUpperCase());
      
      // Add to cart
      addGiftCard({ code: code.toUpperCase(), amount: result.amount });
      setCode('');
