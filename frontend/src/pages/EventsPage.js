...
const EventsPage = () => {
  ...
  return (
    <Box sx={{ bgcolor: '#f7f7f7', py: 4, minHeight: '100vh' }}>
      ...
      <Box id="upcoming" sx={{ py: 8, bgcolor: 'grey.100' }}>
        <Container>
      ...
      {/* Past Events Section */}
      <Box id="past-events" sx={{ py: 8, bgcolor: 'grey.100' }}>
        <Container>
          <Typography variant="h4" component="h2" align="center" gutterBottom>
            Past Events & Impact
          </Typography>
          ...
          <Grid container justifyContent="center">
            <Grid item xs={12} md={10} lg={8} textAlign="center">
              <Typography variant="body1" paragraph>
                Visit our dedicated Past Events page to discover the success stories from our previous fundraising activities, volunteer initiatives, conferences, and community events.
              </Typography>
              <Typography variant="body1" paragraph>
                Learn about the impact of our events, see how funds were used, and get inspired to participate in upcoming opportunities.
              </Typography>
              <Button 
                variant="contained" 
                color="primary" 
