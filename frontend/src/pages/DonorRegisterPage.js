  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        await register(fullName, formData.email, formData.password, 'donor');
        
        // Save additional donor data to localStorage
        ...
        userData.donationPreference = formData.donationPreference;
        userData.receiveUpdates = formData.receiveUpdates;
  ...
  const handleSocialLogin = async (provider) => {
    ...
    try {
      ...
      if (result && result.success) {
        ...
        // Send to backend with donor user type
    ...
    <Grid container component="main" sx={{ minHeight: '100vh' }}>
      {!isMobile && (
        <Grid
          ...
          md={7}
          sx={{
            backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.3)), url("https://images.unsplash.com/photo-1616587894289-86480e533129?q=80&w=1470&auto=format&fit=crop")',
        ...
        >
          ...
          >
            ...
            <Typography variant="body1">
              Your support helps us create lasting impact for communities in need around the world.
            </Typography>
          </Box>
        </Grid>
      )}
      ...
      >
        ...
        >
          ...
          <Typography color="text.secondary" sx={{ mb: 3, textAlign: 'center' }}>
            Join our community of supporters making change possible
          </Typography>
          <Box 
            component="form" 
            noValidate 
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <FormControl fullWidth>
                  <InputLabel id="donation-preference-label">Donation Preference</InputLabel>
                  <Select
                    labelId="donation-preference-label"
                    ...
                    onChange={handleInputChange}
                  >
                    <MenuItem value="disasters">Disaster Relief</MenuItem>
              ...
              <Grid item xs={12}>
                <FormControlLabel
                  ...
                  label="I want to receive updates about fundraising campaigns and impact stories"
                />
              </Grid>
              <Grid item xs={12}>
                <FormControlLabel
